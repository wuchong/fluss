...
public final class TestData {
    ...
    public static final List<Object[]> DATA1 = Arrays.asList(
            new Object[] {1, "a"},
            new Object[] {2, "b"},
            new Object[] {3, "c"},
            new Object[] {4, "d"},
            ...
            new Object[] {9, "i"},
            new Object[] {10, "j"});
    public static final List<Object[]> ANOTHER_DATA1 = Arrays.asList(
            new Object[] {1, "a1"},
            new Object[] {2, "b1"},
            new Object[] {3, "c1"},
            new Object[] {4, "d1"},
    ...
    public static final RowType DATA1_ROW_TYPE =
            DataTypes.ROW(new DataField("a", DataTypes.INT()), new DataField("b", DataTypes.STRING()));

    // for log table
    public static final long DATA1_TABLE_ID = 150001L;
    public static final Schema DATA1_SCHEMA = Schema.newBuilder()
            .column("a", DataTypes.INT())
            .withComment("a is first column")
            .column("b", DataTypes.STRING())
            .withComment("b is second column")
            .build();
    public static final TablePath DATA1_TABLE_PATH = TablePath.of("test_db_1", "test_non_pk_table_1");
    ...
    public static final PhysicalTablePath DATA1_PHYSICAL_TABLE_PATH = PhysicalTablePath.of(DATA1_TABLE_PATH);

    private static final long currentMillis = System.currentTimeMillis();
    public static final TableInfo DATA1_TABLE_INFO =
            TableInfo.of(DATA1_TABLE_PATH, DATA1_TABLE_ID, 1, DATA1_TABLE_DESCRIPTOR, currentMillis, currentMillis);

    // for log table / partition table
    public static final TableDescriptor DATA1_PARTITIONED_TABLE_DESCRIPTOR = TableDescriptor.builder()
            .schema(DATA1_SCHEMA)
            .distributedBy(3)
            .partitionedBy("b")
    ...
    public static final Schema DATA1_SCHEMA_PK = Schema.newBuilder()
            .column("a", DataTypes.INT())
            .withComment("a is first column")
            .column("b", DataTypes.STRING())
            .withComment("b is second column")
            .primaryKey("a")
            .build();
    public static final TablePath DATA1_TABLE_PATH_PK = TablePath.of("test_db_1", "test_pk_table_1");
    public static final long DATA1_TABLE_ID_PK = 150003L;

    public static final TableDescriptor DATA1_TABLE_DESCRIPTOR_PK = TableDescriptor.builder()
            .schema(DATA1_SCHEMA_PK)
            .distributedBy(3, "a")
            .build();
    public static final PhysicalTablePath DATA1_PHYSICAL_TABLE_PATH_PK = PhysicalTablePath.of(DATA1_TABLE_PATH_PK);
    public static final TableInfo DATA1_TABLE_INFO_PK = TableInfo.of(
            DATA1_TABLE_PATH_PK, DATA1_TABLE_ID_PK, 1, DATA1_TABLE_DESCRIPTOR_PK, currentMillis, currentMillis);

    public static final PhysicalTablePath DATA1_PHYSICAL_TABLE_PATH_PK_PA_2024 =
            PhysicalTablePath.of(DATA1_TABLE_PATH_PK, "2024");

    public static final List<Tuple2<Object[], Object[]>> DATA_1_WITH_KEY_AND_VALUE = Arrays.asList(
    ...
    public static final List<Tuple2<ChangeType, Object[]>> EXPECTED_LOG_RESULTS_FOR_DATA_1_WITH_PK = Arrays.asList(
    ...
    public static final List<Object[]> DATA2 = Arrays.asList(
    ...
    public static final RowType DATA2_ROW_TYPE = DataTypes.ROW(
            new DataField("a", DataTypes.INT()),
            new DataField("b", DataTypes.STRING()),
            new DataField("c", DataTypes.STRING()));
    public static final Schema DATA2_SCHEMA = Schema.newBuilder()
            .column("a", DataTypes.INT())
            .withComment("a is first column")
            .column("b", DataTypes.STRING())
            .withComment("b is second column")
    ...
    public static final PhysicalTablePath DATA2_PHYSICAL_TABLE_PATH = PhysicalTablePath.of(DATA2_TABLE_PATH);
    ...
    public static final TableInfo DATA2_TABLE_INFO = TableInfo.of(
            DATA2_TABLE_PATH,
            DATA2_TABLE_ID,
            1,
    ...
    public static final Schema DATA3_SCHEMA_PK = Schema.newBuilder()
            .column("a", DataTypes.INT())
            .withComment("a is first column")

...
public class S3TestCredentials {
    ...
    @Nullable
    private static final String S3_REGION = System.getenv("IT_CASE_S3_REGION");
    ...
    public static void assumeCredentialsAvailable() {
        assumeTrue(credentialsAvailable(), "No S3 credentials available in this test's environment");
    }

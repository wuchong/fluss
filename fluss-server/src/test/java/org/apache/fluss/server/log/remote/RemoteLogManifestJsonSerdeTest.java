...
class RemoteLogManifestJsonSerdeTest extends JsonSerdeTestBase<RemoteLogManifest> {
    private static final PhysicalTablePath TABLE_PATH1 = PhysicalTablePath.of(TablePath.of("db", "mytable"));
    ...
    private static final RemoteLogManifest MANIFEST_SNAPSHOT1 = new RemoteLogManifest(
            TABLE_PATH1,
            TABLE_BUCKET1,
            Arrays.asList(
                    RemoteLogSegment.Builder.builder()
                            ...
                            .remoteLogSegmentId(UUID.fromString("a4421366-4a1d-4c3b-a0f8-0be2e77b1368"))
                    ...
                    RemoteLogSegment.Builder.builder()
                            .physicalTablePath(TABLE_PATH1)
                            .tableBucket(TABLE_BUCKET1)
                            .remoteLogSegmentId(UUID.fromString("dbfd0ade-23d9-411a-ac05-81e5fe1cabd5"))
    ...
    private static final RemoteLogManifest MANIFEST_SNAPSHOT2 = new RemoteLogManifest(
            TABLE_PATH2,
            TABLE_BUCKET2,
            Arrays.asList(
                    RemoteLogSegment.Builder.builder()
                            ...
                            .remoteLogSegmentId(UUID.fromString("6e94fbd1-c056-446e-859c-77345dddcd96"))
                    ...
                    RemoteLogSegment.Builder.builder()
                            .physicalTablePath(TABLE_PATH2)
                            .tableBucket(TABLE_BUCKET2)
                            .remoteLogSegmentId(UUID.fromString("22901b01-250f-4114-9b01-1a840dd28f4f"))

...
- `netty.server.max-queued-historical-requests`: Change the maximum number of in-flight historical partition operations, including lookups and writes, before throttling new operations.
